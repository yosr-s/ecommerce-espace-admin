	...
	var sparkLine8 = function(){
		if(jQuery('#sparkline8').length > 0 ){	
			$("#sparkline8").sparkline([79, 72, 29, 6, 52, 32, 73, 40, 14, 75, 77, 39, 9, 15, 10], {
				...
				height: "50",
				lineColor: "#01a3ff",
				fillColor: "rgba(149,104,255,1)",
				minSpotColor: "#01a3ff",
				maxSpotColor: "#01a3ff",
				highlightLineColor: "#01a3ff",
				highlightSpotColor: "#01a3ff",
		...
		if(jQuery('#StackedBarChart').length > 0 ){	
			$('#StackedBarChart').sparkline([
				...
				[4, 1, 2]
					...
					barWidth: 10,
					barSpacing: 7, 
					stackedBarColor: ['#01a3ff', '#ffaa2b', '#627eea']
				});
		}
	}
	...
	var sparkLine11 = function(){
		if(jQuery('#sparkline11').length > 0 ){
			...
			$("#sparkline11").sparkline([24, 61, 51], {
				...
				height: "100px",
				resize: !0,
				sliceColors: ["rgba(192, 10, 39, .5)", "rgba(0, 0, 128, .5)", "rgba(149,104,255,1)"]
			});
		}	
	}	
