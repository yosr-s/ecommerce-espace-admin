...
const onDelete = (id) => {
  ...
  <div className="card">
    <div className="card-header">
      <h4 className="card-title">Admins list</h4>
    </div>
        ...
        <table className="table table-bordered table-striped verticle-middle table-responsive-sm">
          ...
          {Admins?.map((item,index)=>{
            ...
            <tr>
              ...
              <td>{item.login}</td>
              <td>                  
                 <> <img style={{width:"100px"}} src={"http://localhost:3000/file/"+item.photo}></img></>
              </td>
              <td><span class="d-flex justify-content-end">
                     <Link to={`/update-admin/${item._id}`} class="me-2 btn btn-primary shadow btn-xs sharp" data-bs-toggle="tooltip"
